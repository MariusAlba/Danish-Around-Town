...
export const Menu = () => {
  return <div className="container App">
    ...
    <h1 className="mb-5"><span>Hej!</span> What would you like to do?</h1>
    <div className="row">
      <div className="col-lg-6">
    <Link to="/Intro">
        <Button className="signUpButton mb-5" variant="success" size="lg" type="submit">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-exclude" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm12 2v7a1 1 0 0 1-1 1H4V5a1 1 0 0 1 1-1h7z"/>
            </svg> Flipcard
        </Button>
    </Link>
    </div>
    ...
    <Link to="/UploadImg">
        <Button className="signUpButton mb-5 testBTT" variant="success" size="lg" type="submit">
          <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-cloud-arrow-up-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="col-lg-5">
    <Link to="/Intro">
            <Button className="signUpButton mb-5" variant="success" size="lg" type="submit">
            <svg width="1em" height="em" viewBox="0 0 16 16" className="bi bi-globe" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
